...
#define step_3_3_rp 110
#define step_4_1_lp -70
...
void step_3(){
	...
	check();
	clearTimer(T1);
	while(sl <= 150&&time1[T1] <= 1000){                              //2.turn right
	...
	SensorValue_start();
	clearTimer(T1);
	while(sl<=600&&time1[T1] <= 2000){                                //3.check
...
void step_4(){
	SensorValue_start();
	clearTimer(T1);
	while(sl >= -820&&time1[T1] <= 5000){                                    //1.go back
